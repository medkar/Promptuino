...
from .ollama_backend import (OllamaBackend, is_installed, is_server_running,
                             is_model_available, list_local_models)
...
__all__ = [
    ...
    "is_installed", "is_server_running", "is_model_available",
    "list_local_models",
