...
class Strings:
    ...
    md_delete_tip:              str
    md_delete_title:            str
    md_delete_confirm:          str
    md_delete_in_use:           str
    md_deleted:                 str
    update_check:               str
    update_checking:            str
...
TRANSLATIONS: dict[str, Strings] = {
    "fr": Strings(
        ...
        md_downloaded               = "Modèles déjà téléchargés",
        md_none                     = "Aucun modèle téléchargé pour l'instant.",
        md_other                    = "Un autre modèle",
        md_other_help               = "Trouvez son nom exact sur {lien}, puis collez-le ici. Précisez le nombre de paramètres dans le nom (ex. <b>llama3.1:8b</b>) — c'est lui qui décide de la taille.",
        md_download                 = "Télécharger",
        md_already                  = "déjà téléchargé",
        md_fits                     = "tient dans votre carte ({vram})",
        md_too_big                  = "trop gros pour votre carte ({vram})",
        md_unknown_vram             = "⚠️ Le modèle doit tenir dans la mémoire de votre carte graphique. Sans carte dédiée, la génération fonctionnera mais sera <b>très lente</b>.",
        md_cancel                   = "Annuler",
        ...
        md_free_locked              = "Ollama verrouille encore certains fichiers — réessayez dans quelques secondes.",
        md_no_space                 = "Espace disque insuffisant : le modèle fait {taille}, il ne reste que {libre} (marge gardée : 2 Go). Libérez de la place, puis réessayez.",
        md_delete_tip               = "Supprimer ce modèle",
        md_delete_title             = "Supprimer le modèle",
        md_delete_confirm           = "Supprimer {nom} ({taille}) ?\n\nIl faudra le retélécharger pour le réutiliser.",
        md_delete_in_use            = "\n\n⚠️ C'est le modèle actuellement utilisé par Promptuino : la génération ne fonctionnera plus tant qu'un autre modèle n'est pas choisi ou celui-ci retéléchargé.",
        md_deleted                  = "{nom} supprimé.",
        update_check                = "Rechercher une mise à jour",
        update_checking             = "Vérification…",
        update_up_to_date           = "Vous avez la dernière version.",
        update_available            = "Version {v} disponible.",
        update_failed               = "Impossible de vérifier pour l'instant.",
        update_banner               = "<b>Promptuino {v}</b> est disponible.",
        update_download             = "Télécharger",
        ia_ollama_not_installed    = "Ollama n'est pas installé — <a href=\"https://ollama.com\">le télécharger</a>, puis l'ouvrir et revenir ici",
        ia_ollama_not_running       = "Ollama n'est pas lancé — ouvrez l'application Ollama, puis revenez ici",
    ...
    "en": Strings(
        ...
        md_downloaded               = "Already downloaded",
        md_none                     = "No model downloaded yet.",
        md_other                    = "Another model",
        md_other_help               = "Find its exact name on {lien}, then paste it here. Include the parameter count in the name (e.g. <b>llama3.1:8b</b>) — it is what decides the size.",
        md_download                 = "Download",
        md_already                  = "already downloaded",
        md_fits                     = "fits on your card ({vram})",
        md_too_big                  = "too large for your card ({vram})",
        md_unknown_vram             = "⚠️ The model must fit in your graphics card's memory. Without a dedicated card, generation will work but will be <b>very slow</b>.",
        md_cancel                   = "Cancel",
        ...
        md_free_locked              = "Ollama still locks some files — try again in a few seconds.",
        md_no_space                 = "Not enough disk space: the model is {taille}, only {libre} left (2 GB safety margin kept). Free some space, then try again.",
        md_delete_tip               = "Delete this model",
        md_delete_title             = "Delete the model",
        md_delete_confirm           = "Delete {nom} ({taille})?\n\nYou will need to download it again to reuse it.",
        md_delete_in_use            = "\n\n⚠️ This is the model Promptuino currently uses: generation will stop working until another model is selected or this one is downloaded again.",
        md_deleted                  = "{nom} deleted.",
        update_check                = "Check for updates",
        update_checking             = "Checking…",
        update_up_to_date           = "You have the latest version.",
        update_available            = "Version {v} is available.",
        update_failed               = "Cannot check right now.",
        update_banner               = "<b>Promptuino {v}</b> is available.",
        update_download             = "Download",
        ia_ollama_not_installed     = "Ollama is not installed — <a href=\"https://ollama.com\">download it</a>, then open it and come back here",
        ia_ollama_not_running       = "Ollama is not running — open the Ollama application, then come back here",
    ...
    "es": Strings(
        ...
        md_downloaded               = "Ya descargados",
        md_none                     = "Aún no hay ningún modelo descargado.",
        md_other                    = "Otro modelo",
        md_other_help               = "Busca su nombre exacto en {lien} y pégalo aquí. Incluye el número de parámetros en el nombre (p. ej. <b>llama3.1:8b</b>): es lo que decide el tamaño.",
        md_download                 = "Descargar",
        md_already                  = "ya descargado",
        md_fits                     = "cabe en tu tarjeta ({vram})",
        md_too_big                  = "demasiado grande para tu tarjeta ({vram})",
        md_unknown_vram             = "⚠️ El modelo debe caber en la memoria de tu tarjeta gráfica. Sin tarjeta dedicada, la generación funcionará pero será <b>muy lenta</b>.",
        md_cancel                   = "Cancelar",
        ...
        md_free_locked              = "Ollama aún bloquea algunos archivos — inténtalo de nuevo en unos segundos.",
        md_no_space                 = "Espacio en disco insuficiente: el modelo ocupa {taille} y solo quedan {libre} (margen de seguridad: 2 GB). Libera espacio e inténtalo de nuevo.",
        md_delete_tip               = "Eliminar este modelo",
        md_delete_title             = "Eliminar el modelo",
        md_delete_confirm           = "¿Eliminar {nom} ({taille})?\n\nHabrá que descargarlo de nuevo para reutilizarlo.",
        md_delete_in_use            = "\n\n⚠️ Es el modelo que Promptuino usa actualmente: la generación dejará de funcionar hasta elegir otro modelo o descargarlo de nuevo.",
        md_deleted                  = "{nom} eliminado.",
        ...
        update_failed               = "No se puede comprobar ahora mismo.",
        update_banner               = "<b>Promptuino {v}</b> está disponible.",
        update_download             = "Descargar",
        ia_ollama_not_installed     = "Ollama no está instalado — <a href=\"https://ollama.com\">descargarlo</a>, luego ábrelo y vuelve aquí",
        ia_ollama_not_running       = "Ollama no está en ejecución — abre la aplicación Ollama y vuelve aquí",
    ...
    "it": Strings(
        ...
        md_downloaded               = "Già scaricati",
        md_none                     = "Nessun modello ancora scaricato.",
        md_other                    = "Un altro modello",
        md_other_help               = "Trova il suo nome esatto su {lien}, poi incollalo qui. Includi il numero di parametri nel nome (es. <b>llama3.1:8b</b>): è quello che decide la dimensione.",
        md_download                 = "Scarica",
        md_already                  = "già scaricato",
        md_fits                     = "sta nella tua scheda ({vram})",
        md_too_big                  = "troppo grande per la tua scheda ({vram})",
        md_unknown_vram             = "⚠️ Il modello deve stare nella memoria della scheda grafica. Senza una scheda dedicata, la generazione funzionerà ma sarà <b>molto lenta</b>.",
        md_cancel                   = "Annulla",
        ...
        md_free_locked              = "Ollama blocca ancora alcuni file — riprova tra qualche secondo.",
        md_no_space                 = "Spazio su disco insufficiente: il modello occupa {taille}, ne restano solo {libre} (margine di sicurezza: 2 GB). Libera spazio e riprova.",
        md_delete_tip               = "Elimina questo modello",
        md_delete_title             = "Elimina il modello",
        md_delete_confirm           = "Eliminare {nom} ({taille})?\n\nDovrà essere scaricato di nuovo per riutilizzarlo.",
        md_delete_in_use            = "\n\n⚠️ È il modello attualmente usato da Promptuino: la generazione smetterà di funzionare finché non si sceglie un altro modello o lo si scarica di nuovo.",
        md_deleted                  = "{nom} eliminato.",
        update_check                = "Cerca aggiornamenti",
        update_checking             = "Verifica…",
        update_up_to_date           = "Hai l'ultima versione.",
        update_available            = "La versione {v} è disponibile.",
        update_failed               = "Impossibile verificare al momento.",
        update_banner               = "<b>Promptuino {v}</b> è disponibile.",
        update_download             = "Scarica",
        ia_ollama_not_installed     = "Ollama non è installato — <a href=\"https://ollama.com\">scaricarlo</a>, poi aprilo e torna qui",
        ia_ollama_not_running       = "Ollama non è in esecuzione — apri l'applicazione Ollama, poi torna qui",
...
_EXTRA_STRINGS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "onnx_running":                      "Téléchargement en cours…",
        "onnx_progress":                     "Téléchargement : {done:.1f} / {total:.1f} Mo  ({pct} %)",
        "onnx_done":                         "Téléchargement terminé.",
        "onnx_failed":                       "Échec.",
        "onnx_error_title":                  "Erreur de téléchargement",
        "onnx_cancelled":                 "Téléchargement annulé.",
    ...
    "en": {
        "onnx_window_title":                 "Initial setup — Promptuino",
        "onnx_title":                        "Downloading the search model",
        "onnx_desc":                         "Promptuino needs an embedding model (~449 MB) to recommend Arduino libraries. This file is downloaded only once, then stored locally.",
        "onnx_ready":                        "Ready to download.",
        "onnx_btn_cancel":                   "Cancel",
        "onnx_btn_start":                    "Download",
        "onnx_running":                      "Downloading…",
        "onnx_progress":                     "Downloading: {done:.1f} / {total:.1f} MB  ({pct}%)",
        "onnx_done":                         "Download complete.",
        "onnx_failed":                       "Failed.",
        "onnx_error_title":                  "Download error",
        "onnx_cancelled":                 "Download cancelled.",
    ...
    "es": {
        "onnx_window_title":                 "Configuración inicial — Promptuino",
        "onnx_title":                        "Descarga del modelo de búsqueda",
        "onnx_desc":                         "Promptuino necesita un modelo de embedding (~449 MB) para recomendar bibliotecas de Arduino. Este archivo se descarga una sola vez y luego se guarda localmente.",
        "onnx_ready":                        "Listo para descargar.",
        "onnx_btn_cancel":                   "Cancelar",
        "onnx_btn_start":                    "Descargar",
        "onnx_running":                      "Descargando…",
        "onnx_progress":                     "Descargando: {done:.1f} / {total:.1f} MB  ({pct} %)",
        "onnx_done":                         "Descarga completada.",
        "onnx_failed":                       "Error.",
        "onnx_error_title":                  "Error de descarga",
        "onnx_cancelled":                 "Descarga cancelada.",
    ...
    "it": {
        "onnx_window_title":                 "Configurazione iniziale — Promptuino",
        "onnx_title":                        "Download del modello di ricerca",
        "onnx_desc":                         "Promptuino ha bisogno di un modello di embedding (~449 MB) per consigliare le librerie Arduino. Questo file viene scaricato una sola volta e poi memorizzato localmente.",
        "onnx_ready":                        "Pronto per il download.",
        "onnx_btn_cancel":                   "Annulla",
        "onnx_btn_start":                    "Scarica",
        "onnx_running":                      "Download in corso…",
        "onnx_progress":                     "Download: {done:.1f} / {total:.1f} MB  ({pct} %)",
        "onnx_done":                         "Download completato.",
        "onnx_failed":                       "Errore.",
        "onnx_error_title":                  "Errore di download",
        "onnx_cancelled":                 "Download annullato.",
